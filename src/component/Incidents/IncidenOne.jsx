...
const IncidenOne = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full max-w-[1270px] py-4 px-2 md:px-0 mx-auto font-onset-font gap-4 md:gap-0">
